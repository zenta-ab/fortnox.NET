...
namespace FortnoxNET.Services
{
    public class VoucherSeriesService
    {
        ...
        {
            var apiRequest = new FortnoxApiClientRequest<ListedResourceResponse<VoucherSeriesSubset>>(HttpMethod.Get, listRequest,
        ...
        {
            var apiRequest = new FortnoxApiClientRequest<SingleResource<VoucherSeries>>(HttpMethod.Get, request,
        ...
        {
            var apiRequest =
                new FortnoxApiClientRequest<SingleResource<VoucherSeries>>(HttpMethod.Post, request, $"{ApiEndpoints.VoucherSeries}")
                {
        ...
        {
            var apiRequest =
                new FortnoxApiClientRequest<SingleResource<VoucherSeries>>(HttpMethod.Put, request,
